# Generated by Django 3.2 on 2021-04-16 19:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255, verbose_name='Название компетенции')),
                ('ed_competence', models.ManyToManyField(related_name='ed_to_emp_competence', to='main_app.EdCompetence')),
            ],
        ),
        migrations.CreateModel(
            name='Skills',
        ...
        migrations.AddField(
            ...
            name='emp_competence',
            field=models.ManyToManyField(related_name='emp_to_ed_competence', to='main_app.EmpCompetence'),
        ),
    ]
